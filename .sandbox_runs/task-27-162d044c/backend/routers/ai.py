...
@router.put("/api/roles/{role_id}", dependencies=[Depends(verify_token)])
...
@router.delete("/api/roles/{role_id}", dependencies=[Depends(verify_token)])
async def delete_role(role_id: int):
    db.delete_role(role_id)
    return {"status": "success"}


@router.post("/api/roles/{role_id}/activate", dependencies=[Depends(verify_token)])
